...
@Component({
    templateUrl: './stafAssignJob.component.html',
    providers: [MessageService, ConfirmationService]
})
export class StafAssignJobComponent implements OnInit {
...
//common
    ...
    ngOnInit(): void {
     ...
     this.StafId = this.authService.HaveAccessById();
     console.log(this.authService.HaveAccessByName())
     console.log(this.StafId)

     this.jobAssignService.GetAllJobDetailByStafId(this.StafId).subscribe((data:any)=>{
